...
Artifact types: commit, file, pr, url, deploy, or any custom type.`,
	...
	Example: `  cp artifact add pf-123 commit abc123 "Fixed null pointer bug"
  cp artifact add pf-123 file services/oauth.go "Modified refresh logic"
  cp artifact add pf-123 pr https://github.com/org/repo/pull/42 "PR link"`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		err := cpClient.AddArtifact(ctx, shardID, artifactType, reference, description)
		if err != nil {
			return err
		}
