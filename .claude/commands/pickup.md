...
- Shards in `needs-review` — Penfold finished something, flag to James
- Shards labeled `blocked` — needs guidance, flag to James
...
Good:
> "Picked up. Continuing with board dedup fix."
...
> "Picked up. Note: pf-xxx needs review — dedup fix landed. Continue?"
