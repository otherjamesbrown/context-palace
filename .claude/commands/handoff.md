...
Optional free-text hint from James about what to capture. E.g. "remember we need to rerun that test" or "we were debugging the board query". Use this to guide what you emphasise, but you already know the full context from the conversation — don't limit yourself to just what's mentioned.
