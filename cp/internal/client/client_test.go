...
`
	...
	t.Setenv("CP_HOST", "envhost")
	t.Setenv("CP_DATABASE", "")
	t.Setenv("CP_USER", "")
	t.Setenv("CP_PROJECT", "")
	t.Setenv("CP_AGENT", "")
...
func TestLoadConfig_AllEnvVars(t *testing.T) {
	...
	t.Setenv("CP_HOST", "envhost")
	t.Setenv("CP_DATABASE", "envdb")
	t.Setenv("CP_USER", "envuser")
	t.Setenv("CP_PROJECT", "envproject")
	t.Setenv("CP_AGENT", "envagent")
